...
static_assert(stse::is_serializable_v<std::tuple<serializable_t>>                 == false);
static_assert(stse::is_serializable_v<std::pair<serializable_t,serializable_t>>   == false);
static_assert(stse::is_serializable_v<std::priority_queue<int, static_container>> == false);
